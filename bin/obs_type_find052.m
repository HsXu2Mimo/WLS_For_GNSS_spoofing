function [Obs_columns, nObs_types] = obs_type_find052(Obs_types, sysId)
...
%                 idD2 = {'D2W';'D2P';'D2C';'D2S';'D2L';'D2X'};    %L2,L2C
                %--------------------------------
%                 idC2 = {'C2W';'C2P';'C2C'}; 
                idP2 = {'C5X';'C2W';'C2P';'C2C';'C2S';'C2L';'C2X'};               %L5
                idL2 = {'L5X';'L2W';'L2P';'L2C';'L2S';'L2L';'L2X'};               %L5
                idS2 = {'S5X';'S2W';'S2P';'S2C';'S2S';'S2L';'S2X'};               %L5
                idD2 = {'D5X';'D2W';'D2P';'D2C';'D2S';'D2L';'D2X'};               %L5
                %--------------------------------
            case 'R' %GLONASS
                idC1 = {'C1C'};               %R1
                idP1 = {'C1P'};               %R1
            ...
            case 'E' %Galileo
                ...
                idD1 = {'D1X';'D1C'};         %E1
                %--------------------------------
                idP2 = {'C5X';'C5Q';'C7X';'C7Q';'C8X';'C8Q'};        %E5a
                idL2 = {'L5X';'L5Q';'L7X';'L7Q';'L8X';'L8Q'};        %E5a
                idS2 = {'S5X';'S5Q';'S7X';'S7Q';'S8X';'S8Q'};        %E5a
                idD2 = {'D5X';'D5Q';'D7X';'D7Q';'D8X';'D8Q'};        %E5a
                %--------------------------------
                %idP2 = {'C7X';'C7Q'};        %E5b
                %idL2 = {'L7X';'L7Q'};        %E5b
                %idS2 = {'S7X';'S7Q'};        %E5b
